...
class TestNPUCommunicatorUnit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        sys.modules['vllm.distributed.device_communicators.base_device_communicator'] = MagicMock()
        
        # Create a proper mock base class that can be instantiated
        class MockDeviceCommunicatorBase:
        ...
        self.base_communicator_mock = MockDeviceCommunicatorBase
        sys.modules['vllm.distributed.device_communicators.base_device_communicator'].DeviceCommunicatorBase = self.base_communicator_mock
