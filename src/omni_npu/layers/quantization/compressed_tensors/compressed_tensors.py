...
from omni_npu.layers.quantization.compressed_tensors.schemes.compressed_tensors_w8a8_int8 import AscendCompressedTensorsW8A8Int8LinearMethod
from omni_npu.layers.quantization.compressed_tensors.compressed_tensors_moe import AscendCompressedTensorsW8A8Int8MoEMethod


ASCEND_COMPRESSED_TENSORS = "ascend-compressed-tensors"
...
class AscendCompressedTensorsConfig(CompressedTensorsConfig):
    ...
    def _get_weight_num_bits(
            self, layer_name: str, weight_quant: QuantizationArgs
        ) -> bool:
    ...
    def _is_dynamic_token_w8a8(
            self, weight_quant: QuantizationArgs, input_quant: QuantizationArgs, weight_num_bits: int
        ) -> bool:
    ...
    def from_config(cls, config: Dict[str, Any]) -> "CompressedTensorsConfig":
        ...
        for _, quant_config in config["config_groups"].items():
            ...
            for target in targets:
                ...
                target_scheme_map[target][
                    "weights"] = QuantizationArgs.model_validate(quant_config.get("weights"))
    ...
    def get_moe_method(self, layer: FusedMoE):
        ...
        if self._is_dynamic_token_w8a8(weight_quant, input_quant, weight_num_bits):
            return (AscendCompressedTensorsW8A8Int8MoEMethod(layer.moe_config), weight_num_bits)
    ...
    def get_quant_method(self, layer: torch.nn.Module,
        ...
        if isinstance(layer, LinearBase):
            ...
            moe_method, weight_num_bits = self.get_moe_method(layer)
