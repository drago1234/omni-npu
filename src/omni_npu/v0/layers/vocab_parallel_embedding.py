...
from omni_npu.v0.distributed.parallel_state import get_local_world_group, get_world_group
from omni_npu.v0.distributed.communication_op import all_gather_local, reduce_scatter_local
