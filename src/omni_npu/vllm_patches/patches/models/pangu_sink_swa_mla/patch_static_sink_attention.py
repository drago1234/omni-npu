...
class StaticSinkAttentionPatch(VLLMPatch):
    _attr_names_to_apply = ['PanguSinkAttentionBase', 'StaticSinkAttention', 'StaticSinkMLAAttention']
    # patch start
    ...
    layers.static_sink_attention.PanguSinkAttentionBase = PanguSinkAttentionBase
